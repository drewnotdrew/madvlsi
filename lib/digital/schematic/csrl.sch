...
C {lab_pin.sym} 280 -60 3 0 {name=p1 sig_type=std_logic lab=VN}
C {lab_pin.sym} 280 -210 3 0 {name=p3 sig_type=std_logic lab=VN}
C {lab_pin.sym} 280 -450 1 0 {name=p13 sig_type=std_logic lab=VP

}
C {lab_pin.sym} 140 -390 1 0 {name=p2 sig_type=std_logic lab=VP

}
C {iopin.sym} 390 -340 0 0 {name=p5 lab=Q}
C {iopin.sym} 390 -280 0 0 {name=p6 lab=Qn}
C {iopin.sym} 70 -340 2 0 {name=p8 lab=D}
C {iopin.sym} 70 -280 2 0 {name=p10 lab=Dn}
