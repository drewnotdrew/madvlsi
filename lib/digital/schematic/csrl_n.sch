...
N 250 -270 250 -190 {lab=Qn}
N 180 -180 250 -180 {lab=Qn}
N 340 -300 360 -300 {lab=Qn}
N 360 -300 360 -190 {lab=Qn}
N 250 -180 360 -180 {lab=Qn}
N 310 -240 310 -150 {lab=Q}
N 190 -250 190 -240 {lab=Q}
N 310 -250 310 -240 {lab=Q}
N 250 -190 250 -180 {lab=Qn}
N 360 -190 360 -180 {lab=Qn}
N 250 -180 250 -150 {lab=Qn}
N 200 -120 220 -120 {lab=Q}
N 190 -240 190 -120 {lab=Q}
N 190 -300 200 -300 {lab=Q}
N 190 -240 200 -240 {lab=Q}
N 170 -180 180 -180 {lab=Qn}
N 190 -120 200 -120 {lab=Q}
N 310 -240 390 -240 {lab=Q}
N 360 -180 390 -180 {lab=Qn}
N 340 -120 360 -120 {lab=Qn}
N 360 -180 360 -120 {lab=Qn}
...
N 250 -360 250 -330 {lab=#net1}
N 250 -360 310 -360 {lab=#net1}
N 310 -360 310 -330 {lab=#net1}
