...
N 380 -630 380 -610 {lab=#net2}
N 330 -630 380 -630 {lab=#net2}
N 330 -630 330 -490 {lab=#net2}
...
.control
  ...
  while code < 128
    ...
    save all
    op
    wrdata ~/documents/git/madvlsi/dac/build/m2m_ladder_biased/m2m_ladder_biased_tb.txt i(Vout) i(V3) v(b0) v(b1) v(b2) v(b3) v(b4) v(b5) v(b6) 
    if code eq 0
      set appendwrite
...
C {bias_gen.sym} 110 -370 0 0 {name=X2 u_w=3 u_l=3 m=2 r=1k}
C {devices/lab_pin.sym} 330 -410 0 0 {name=l38 sig_type=std_logic lab=I_in}
C {madvlsi/vsource.sym} 380 -580 0 0 {name=V3
value=1.8}
C {madvlsi/gnd.sym} 380 -550 0 0 {name=l26 lab=GND}
C {madvlsi/pmos3.sym} 330 -460 0 0 {name=M1
L=3
W=3
body=VDD
nf=1
...
C {devices/lab_pin.sym} 300 -460 0 0 {name=l27 sig_type=std_logic lab=vbp}
